		...
		<td><br />
			...
			<form name="f" method="post">
				...
				<table border="0" cellpadding="0" cellspacing="1" width="590"
					...
					<tr>
						<td width=50 align=center bgcolor="ffffff" height="20">${guestList.guest_no}</td>
						<td width=300 bgcolor="ffffff" style="padding-left: 10">
							<a href="guest_view.do?guest_no=${guestList.guest_no}" class="user">${guestList.guest_title}</a>
						</td>
						<td width=120 align=center bgcolor="ffffff">${guestList.guest_name}</td>
						<td width=120 align=center bgcolor="ffffff">${guestList.guest_date.substring(0,10)}</td>
					</tr>
					</c:forEach>
					<!--loop end  -->
