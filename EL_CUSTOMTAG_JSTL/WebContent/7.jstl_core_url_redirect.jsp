...
<c:url var="mainUrlParam" scope="page" value="7.jstl_core_url_redirect_main.jsp">
	<c:param name="id" value="mint"/>	
	<c:param name="name" value="미인태!"/>	
</c:url>

<a href="${mainUrlParam}">메인7[파라미터]</a><br>
<%-- 
