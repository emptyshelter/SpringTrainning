...
public class StudentDao {
	...
	public static final String NAMESPACE = "com.mybatis3.mapper.StudentMapper.";
...
//		int updateRowCount = 
//				sqlSession.update(NAMESPACE+"updateStudent"+student);
//		sqlSession.close();
//		return updateRowCount;
//	}
	public int updateStudent(Student student) {
		SqlSession sqlSession = sqlSessionFactory.openSession(true);
		int updateRowCount = sqlSession.delete(NAMESPACE + "updateStudent", student);
		sqlSession.close();
		return updateRowCount;
	}
...
//	}
	...
	public Student findStudentsByIdWithAddressResultMap(Integer studId) {
		SqlSession sqlSession = sqlSessionFactory.openSession(true);
		Student student = sqlSession.selectOne(NAMESPACE + "findStudentsByIdWithAddressResultMap", studId);
		sqlSession.close();
		return student;
	}
	...
	public Student findStudentById(Integer studId) {
		/*
		 * true : autocommit true sqlSession.close(); false : autocommit false
		...
		try {
			...
			findStudent = sqlSession.selectOne(NAMESPACE + "findStudentById", studId);
		} finally {
			sqlSession.close();
		}
		return findStudent;
	...
	public List<Student> findAllStudents() {
		...
		try {
			sqlSession = sqlSessionFactory.openSession(true);
			studentList = sqlSession.selectList(NAMESPACE + "findAllStudents");
		} finally {
			sqlSession.close();
		}
		return studentList;
	...
	public HashMap findStudentByIdMap(Integer studId) {
		...
		try {
			sqlSession = sqlSessionFactory.openSession(true);
			findStudentMap = sqlSession.selectOne(NAMESPACE + "findStudentByIdMap", studId);
		} finally {
			sqlSession.close();
		}
	...
	public List<HashMap> findAllStudentsMap() {
		...
		try {
			sqlSession = sqlSessionFactory.openSession(true);
			studentMapList = sqlSession.selectList(NAMESPACE + "findAllStudentsMap");
		} finally {
			sqlSession.close();
		}
	...
	public Student findStudentByIdResultMap(Integer studId) {
		...
		try {
			sqlSession = sqlSessionFactory.openSession(true);
			findStudent = sqlSession.selectOne(NAMESPACE + "findStudentByIdResultMap", studId);
		} finally {
			sqlSession.close();
		}
		return findStudent;
	...
	public List<Student> findAllStudentsResultMap() {
		...
		try {
			sqlSession = sqlSessionFactory.openSession(true);
			studentList = sqlSession.selectList(NAMESPACE + "findAllStudentsResultMap");
		} finally {
			sqlSession.close();
		}
		return studentList;
